...
const images = document.getElementById('project-img');
const details = document.getElementById('newdetail');
const projectsrcs = document.getElementById('projectsrc');
const projectnames = document.getElementById('projectname');
const subprojectnames = document.getElementById('subprojectname');
const years = document.getElementById('year');
const frontendBackendDev = document.getElementById('frontend/backend');
